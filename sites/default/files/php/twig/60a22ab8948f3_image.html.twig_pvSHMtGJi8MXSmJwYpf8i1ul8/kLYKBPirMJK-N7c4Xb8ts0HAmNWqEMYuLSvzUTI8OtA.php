...
class __TwigTemplate_a03961b2f7c001c476560a4c0acb930a1d859462fddb3741f7159ac8880a0b37 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["theme"] ?? null), "settings", [], "any", false, false, true, 17), "image_responsive", [], "any", false, false, true, 17)) ? ("img-responsive") : (""))];
        // line 19
        echo "<img";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method", false, false, true, 19), 19, $this->source), "html", null, true));
        echo " />
";
    }
    ...
    {
        return new Source("", "themes/bootstrap/templates/system/image.html.twig", "C:\\wamp\\www\\test.loc\\themes\\bootstrap\\templates\\system\\image.html.twig");
    }

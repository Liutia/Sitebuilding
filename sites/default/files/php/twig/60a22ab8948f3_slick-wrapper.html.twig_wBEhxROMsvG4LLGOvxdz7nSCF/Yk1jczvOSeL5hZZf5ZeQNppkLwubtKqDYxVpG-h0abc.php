...
class __TwigTemplate_46d0a6440b0a77dd4afdf4b57a3a72e0d436915d097b65fa49c3f4844f1d1c5f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25), 25, $this->source), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "modules/slick/templates/slick-wrapper.html.twig", "C:\\wamp\\www\\test.loc\\modules\\slick\\templates\\slick-wrapper.html.twig");
    }

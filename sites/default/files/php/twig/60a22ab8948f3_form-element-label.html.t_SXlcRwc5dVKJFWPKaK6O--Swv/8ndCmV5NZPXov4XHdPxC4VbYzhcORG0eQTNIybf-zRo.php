...
class __TwigTemplate_d78e9af7cb5a6ec2021224fce336b18f785a9aa3ff71a944b2c4ea994b791a80 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["required"] ?? null)) ? ("form-required") : (""))];
        ...
        if ((( !twig_test_empty(($context["title"] ?? null)) || ($context["is_checkbox"] ?? null)) || ($context["is_radio"] ?? null))) {
            ...
            echo ">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["element"] ?? null), 43, $this->source), "html", null, true));
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 43, $this->source), "html", null, true));
            // line 44
            if (($context["description"] ?? null)) {
                // line 45
                echo "<p class=\"help-block\">";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["description"] ?? null), 45, $this->source), "html", null, true));
                echo "</p>";
            }
            // line 47
            echo "</label>";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/form-element-label.html.twig", "C:\\wamp\\www\\test.loc\\themes\\bootstrap\\templates\\input\\form-element-label.html.twig");
    }

...
class __TwigTemplate_9aed224845bf4ba96f31f031db0d471d7297d1b3c5703b20d02ff5b105a9ee92 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["plugin_id"] ?? null), 41, $this->source)))];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 47
            echo "    <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "visually-hidden"], "method", false, false, true, 47), 47, $this->source), "html", null, true));
            echo ">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["label"] ?? null), 47, $this->source), "html", null, true));
            echo "</h2>
  ";
        }
        // line 49
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 51
        echo "    ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 51, $this->source), "html", null, true));
        echo "
  ";
    }
    ...
    {
        return new Source("", "themes/bootstrap/templates/block/block--search.html.twig", "C:\\wamp\\www\\test.loc\\themes\\bootstrap\\templates\\block\\block--search.html.twig");
    }
